...
definition(
    name: "DIY Initial State Event Streamer - alt bucket",
...
def installed() {
	...
	atomicState.bucketKey = "QEP59A4UDKU8" //change if needed
	atomicState.bucketName = "SmartThings-Alt" //change if wanted
